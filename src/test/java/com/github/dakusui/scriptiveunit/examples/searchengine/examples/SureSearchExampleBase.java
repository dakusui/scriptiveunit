...
import com.github.dakusui.scriptiveunit.examples.searchengine.*;
...
public abstract class SureSearchExampleBase {
  @Import
  ...
  @Import
  public final SearchEngineSupport<SureSearchRequest, SureSearchResponse, ApplicationSpec.Dictionary>
      searchEngineSupport = new SearchEngineSupport<>(
